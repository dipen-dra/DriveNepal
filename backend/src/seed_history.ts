...
const vehicleData = [
  {
    ...
    type: 'car', category: 'Electric', pricePerDay: 125, fuel: 'Electric',
  ...
  },
  {
    ...
    type: 'car', category: 'SUV', pricePerDay: 98, fuel: 'Diesel',
  ...
  },
  {
    ...
    type: 'car', category: 'Luxury', pricePerDay: 145, fuel: 'Petrol',
  ...
  },
  {
    ...
    type: 'car', category: 'Economy', pricePerDay: 42, fuel: 'Petrol',
  ...
  },
  {
    ...
    type: 'car', category: 'Sports', pricePerDay: 280, fuel: 'Petrol',
  ...
  },
  {
    ...
    pricePerDay: 28, fuel: 'Petrol', transmission: 'Manual', seats: 2,
  ...
  },
  {
    ...
    type: 'bike', category: 'Sports', pricePerDay: 22, fuel: 'Petrol',
  ...
  },
  {
    ...
    type: 'bike', category: 'Scooter', pricePerDay: 9, fuel: 'Petrol',
  ...
  },
  {
    ...
    pricePerDay: 58, fuel: 'Petrol', transmission: 'Manual', seats: 2,
...
const mockUserData = [
  { name: 'John Doe', email: 'john@rentalsphere.com', phone: '07700900077', city: 'London', license: 'UK-01020304' },
  { name: 'Alice Smith', email: 'alice@rentalsphere.com', phone: '07700900088', city: 'Edinburgh', license: 'UK-98765432' },
  { name: 'Rory Smith', email: 'rory@rentalsphere.com', phone: '07700900011', city: 'Manchester', license: 'UK-24681012' },
  { name: 'Stella Thomas', email: 'stella@rentalsphere.com', phone: '07700900022', city: 'Birmingham', license: 'UK-13579111' },
  { name: 'David Miller', email: 'david@rentalsphere.com', phone: '07700900033', city: 'London', license: 'UK-99887766' },
  { name: 'Patricia Green', email: 'patricia@rentalsphere.com', phone: '07700900044', city: 'Edinburgh', license: 'UK-33445566' },
  { name: 'Benjamin Adams', email: 'benjamin@rentalsphere.com', phone: '07700900055', city: 'London', license: 'UK-44556677' },
  { name: 'Kieran Cooper', email: 'kieran@rentalsphere.com', phone: '07700900066', city: 'Manchester', license: 'UK-11223344' },
  { name: 'Sophie Watson', email: 'sophie@rentalsphere.com', phone: '07700900099', city: 'London', license: 'UK-66778899' },
  { name: 'Aaron Perry', email: 'aaron@rentalsphere.com', phone: '07700900100', city: 'London', license: 'UK-88776655' },
];

const querySubjects = [
  { subject: 'Winter Tyres Availability', message: 'Do your SUVs come with winter tyres for Highland travel?' },
  { subject: 'Heathrow Airport Pickup details', message: 'Is it possible to drop off the Fortuner directly at London Heathrow Airport?' },
  { subject: 'Insurance coverage query', message: 'What does the maximum insurance cover in case of dent or scratches on country lanes?' },
  { subject: 'Rent with driver option', message: 'Do you offer a driver along with the rental option? If yes, what is the daily rate?' },
  { subject: 'Mileage limitations', message: 'Are there any daily mileage limits, or is it unlimited driving within the UK?' },
  { subject: 'Pannier bags availability', message: 'Are the Himalayan bikes equipped with panniers and crash guards before Highland tours?' },
  { subject: 'Booking cancellation refund', message: 'If I cancel my booking 24 hours in advance, do I get a full refund to my payment card?' },
  { subject: 'License requirements for US citizens', message: 'Is a US driving license fully accepted to rent a car in the UK?' },
  { subject: 'Extended rental request', message: 'I need a vehicle for 3 months. Do you offer long-term corporate rates?' },
  { subject: 'Payment confirmation issue', message: 'I initiated a card payment but the page got disconnected. How can I verify my booking status?' },
];
