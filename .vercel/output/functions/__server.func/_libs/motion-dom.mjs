import { M as MotionGlobalConfig, q as noop, f as clamp, r as pipe, p as millisecondsToSeconds, u as secondsToMilliseconds, v as velocityPerSecond, i as invariant, s as progress, k as isEasingArray, h as easingDefinitionToFunction, g as easeInOut, o as memo, j as isBezierDefinition, d as circInOut, c as backInOut, b as anticipate, l as isNumericalString, S as SubscriptionManager, n as isZeroValueString, m as isObject, e as circOut, a as addUniqueItem, t as removeItem } from "./motion-utils.mjs";
const stepsOrder = [
  "setup",
  // Compute
  "read",
...
export {
  ...
  mixNumber$1 as K,
  motionValue as L,
  observeTimeline as M,
  optimizedAppearDataAttribute as N,
  percent as O,
  press as P,
  resize as Q,
  ...
  resolveVariant as T,
  resolveVariantFromProps as U,
  scrapeMotionValuesFromProps$1 as V,
  scrapeMotionValuesFromProps as W,
  setDragLock as X,
  setFeatureDefinitions as Y,
  supportsScrollTimeline as Z,
  supportsViewTimeline as _,
  ...
  frame as q,
  frameData as r,
  getFeatureDefinitions as s,
  globalProjectionState as t,
  hover as u,
  interpolate as v,
  isAnimationControls as w,
  isControllingVariants as x,
  isElementTextInput as y,
  isForcedMotionValue as z
};
