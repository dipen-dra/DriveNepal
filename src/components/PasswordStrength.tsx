  ...
  return (
    <div className="space-y-3 mt-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs font-medium text-muted-foreground">{strengthLabels[validation.strength]}</span>
      </div>

      {/* Message */}
      <div className={`flex items-center gap-2 text-xs ${
        validation.isValid ? 'text-green-600 dark:text-green-400' : 'text-amber-600 dark:text-amber-400'
      }`}>
        {validation.isValid ? (
