    ...
    <div className="min-h-screen bg-surface/50">
      <div className="container-page py-10">
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-4 mb-8">
          <div className={cn("h-16 w-16 rounded-full font-bold text-xl inline-flex items-center justify-center ring-4 ring-background shadow-card overflow-hidden", user.avatar ? "bg-background" : "gradient-brand text-white")}>
