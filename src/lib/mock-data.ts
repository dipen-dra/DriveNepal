...
export const vehicles: Vehicle[] = [
  {
    ...
    type: "car", category: "Electric", pricePerDay: 120, fuel: "Electric",
    ...
    location: "London", description: "Silent, swift, and Tesla-clean. Perfect for premium city drives across London.",
  },
  {
    id: "v2", slug: "toyota-fortuner", name: "Toyota Fortuner", brand: "Toyota",
    type: "car", category: "SUV", pricePerDay: 95, fuel: "Diesel",
    ...
    location: "Edinburgh", description: "A commanding SUV built for the UK's country lanes and family expeditions.",
  },
  {
    id: "v3", slug: "bmw-3-series", name: "BMW 3 Series", brand: "BMW",
    type: "car", category: "Luxury", pricePerDay: 140, fuel: "Petrol",
    ...
    location: "London", description: "The ultimate driving machine — refined, fast, and unmistakably German.",
  },
  {
    id: "v4", slug: "hyundai-i20", name: "Hyundai i20", brand: "Hyundai",
    type: "car", category: "Economy", pricePerDay: 45, fuel: "Petrol",
    ...
    location: "London", description: "Compact, efficient, and easy to park — your dependable everyday ride.",
  },
  {
    ...
    location: "London", description: "An icon. Pure sports DNA wrapped in timeless silhouette.",
  },
  {
    id: "v6", slug: "royal-enfield-himalayan", name: "Royal Enfield Himalayan",
    brand: "Royal Enfield", type: "bike", category: "Adventure",
    pricePerDay: 35, fuel: "Petrol", transmission: "Manual", seats: 2,
    ...
    location: "Edinburgh", description: "Built for adventure. Conquer the Highlands and beyond.",
  },
  {
    id: "v7", slug: "yamaha-r15", name: "Yamaha R15 V4", brand: "Yamaha",
    type: "bike", category: "Sports", pricePerDay: 30, fuel: "Petrol",
    ...
    location: "London", description: "Razor-sharp sports DNA in a featherweight chassis.",
  },
  {
    id: "v8", slug: "honda-dio", name: "Honda Dio", brand: "Honda",
    type: "bike", category: "Scooter", pricePerDay: 15, fuel: "Petrol",
    ...
    location: "London", description: "Zip across the city. Stylish, light, and fuel-friendly.",
  },
  {
    id: "v9", slug: "harley-iron-883", name: "Harley-Davidson Iron 883",
    brand: "Harley-Davidson", type: "bike", category: "Cruiser",
    pricePerDay: 60, fuel: "Petrol", transmission: "Manual", seats: 2,
    ...
    location: "London", description: "The sound, the silhouette, the soul. An American legend.",
  },
];
